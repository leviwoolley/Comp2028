// IDENTIFIERS_USED=ArmLAsDcMotor,ArmRAsDcMotor,blAsDcMotor,brAsDcMotor,flAsDcMotor,frAsDcMotor,gamepad1,gamepad2,hangLAsDcMotor,hangRAsDcMotor,servoclawAsCRServo,ServoswivelAsCRServo
  ...
  if (linearOpMode.opModeIsActive()) {
    while (linearOpMode.opModeIsActive()) {
      ...
      if (gamepad1.getRightStickX() <= -0.1) {
        flAsDcMotor.setPower(0.5 * gamepad1.getLeftStickX());
      ...
      if (gamepad2.getRightTrigger() > 0.5) {
        ArmLAsDcMotor.setPower(gamepad2.getRightTrigger());
        ArmRAsDcMotor.setPower(gamepad2.getRightTrigger());
      } else if (gamepad2.getLeftTrigger() > 0.5) {
        ArmLAsDcMotor.setPower(-gamepad2.getLeftTrigger());
        ArmRAsDcMotor.setPower(-gamepad2.getLeftTrigger());
      ...
      if (gamepad2.getLeftStickY() >= 0.1) {
        ...
        ServoswivelAsCRServo.setPower(0.5);
      }
      if (gamepad2.getA()) {
        ...
        servoclawAsCRServo.setPower(0.55);
      }
